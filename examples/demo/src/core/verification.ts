...
import type { ActionEnvelope, ActionPackage, Approval, CanonicalApprovalPayload, Did } from "./types.js";
import type { ExecutionPayload, Hash } from "./types.js";
...
export function computeJsonHash(value: unknown): Hash {
  return {
    alg: "sha-256",
