...
import { loadPlugin } from "../../src/lib/plugin-loader.js";

const pluginsDir = fileURLToPath(new URL("../../../../examples/demo/tests/fixtures/plugins/", import.meta.url));

describe("loadPlugin (sdk)", () => {
